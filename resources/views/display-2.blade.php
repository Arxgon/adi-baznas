...
<body class="overflow-hidden h-screen flex flex-col no-scrollbar"
    ...
    <div class="mb-3 flex flex-wrap z-50 w-full text-sm py-2 bg-gradient-to-r from-yellow-300 to-yellow-500">
        <nav class="w-full mx-auto px-4 flex justify-center items-center">
            <div class="font-extrabold text-xl [text-wrap:balance] text-green-800">
                Terima Kasih
                <span class="text-green-800 inline-flex flex-col h-7 overflow-hidden">
            ...
            <div class="w-full flex-grow flex items-center text-center justify-center">
    ...
    <div class="w-full h-auto px-4 py-1 mx-auto flex justify-center gap-x-3">
        <div class="p-3 flex flex-col w-1/4 bg-white border shadow-sm rounded-xl">
            ...
            <p
                ...
                <span class="font-medium text-lg">Rp</span>80.000.000.000
            </p>
        </div>
        <div class="p-3 flex flex-col w-1/4 bg-white border shadow-sm rounded-xl">
            <div class="flex justify-center items-center">
    ...
    <div class="w-full h-auto px-4 py-1 mx-auto flex justify-center gap-x-3 overflow-auto">
        <div class="w-full flex gap-x-3">
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    ...
                    <p
                        class="inline-flex items-center py-1.5 px-3 rounded-md text-2xl font-bold bg-yellow-100 text-yellow-800 dark:bg-teal-800/30 dark:text-teal-500">
                        <span class="font-medium text-lg">Rp</span>80.000.000.000
                    </p>
                </div>
                <!-- End Header -->
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    ...
                    <p
                        class="inline-flex items-center py-1.5 px-3 rounded-md text-2xl font-bold bg-teal-100 text-teal-800 dark:bg-teal-800/30 dark:text-teal-500">
                        <span class="font-medium text-lg">Rp</span>80.000.000.000</p>
                </div>
                <!-- End Header -->
        ...
        {{-- Table Detail --}}
        <div class="p-3 flex flex-col w-1/3 bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <!-- Header -->
            ...
            <div id="scroll-table" class="flex grow flex-row flex-auto overflow-auto no-scrollbar h-[200px]">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="sticky top-[-1px] bg-gradient-to-r from-yellow-300 to-yellow-500">
                        <tr class="divide-x-2">
                            <th scope="col" class="px-6 py-3 text-start text-md font-bold text-gray-900 dark:text-neutral-500 ">
                                Bulan</th>
                            <th scope="col" class="px-6 py-3 text-end text-md font-bold text-gray-900 dark:text-neutral-500">
                                Penghimpunan</th>
                            <th scope="col" class="px-6 py-3 text-end text-md font-bold text-gray-900 dark:text-neutral-500">
                                Pendistribusian</th>
                        </tr>
                    ...
                    <tbody>
                        <tr class="
                            ...
                            <td
                                class="px-6 py-2 whitespace-nowrap text-lg text-end font-bold text-yellow-900 dark:text-neutral-200">
                                <span class="font-normal text-sm">Rp</span>6.833.624.620
                            </td>
                            <td
                                class="px-6 py-2 whitespace-nowrap text-lg text-end font-bold text-teal-800 dark:text-neutral-200">
                                <span class="font-normal text-sm">Rp</span>6.833.624.620
                            </td>
                        </tr>
                        <tr class="
    ...
    <div class="w-full h-auto px-4 py-1 mx-auto flex justify-center overflow-auto gap-x-3">

        <div class="p-3 w-1/2 flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <!-- Title -->
                        ...
                        <div
                            ...
                            <table class="min-w-full text-center divide-y divide-gray-200 dark:divide-neutral-700">
                                <tbody class="divide-y-2 divide-green-950 dark:divide-neutral-700">
                                    <tr class="divide-x-2 divide-green-950 font-bold text-lg bg-gradient-to-r from-slate-50 to-green-100">
                                        <td class="py-2 bg-gradient-to-r from-emerald-700 to-[#3f6228] bg-clip-text text-transparent">
                                            KETUA
                                        </td>
                                        <td class="py-1 bg-gradient-to-r from-red-500 to-red-800 text-white">TIDAK ADA</td>
                                    </tr>
                                    <tr class="divide-x-2 divide-green-950 font-bold text-lg bg-gradient-to-t from-slate-50 to-green-100">
                                        <td class="py-2 bg-gradient-to-t from-emerald-700 to-[#3f6228] bg-clip-text text-transparent">
                                            WAKIL KETUA I
                                        </td>
                                        <td class="py-1 bg-gradient-to-r from-red-500 to-red-800 text-white">TIDAK ADA</td>
                                    </tr>
                                    ...
                                    <tr class="divide-x-2 divide-green-950 font-bold text-lg bg-gradient-to-r from-slate-50 to-green-100">
                                        ...
                                        <td class="py-1 bg-gradient-to-r from-green-500 to-green-700 text-white">ADA</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="w-1/2 bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <!-- Slider -->
    ...
    <div class="fixed bottom-0 left-0 mt-3 flex flex-row z-50 w-full text-sm py-1 bg-gradient-to-r from-yellow-100 to-yellow-500">
        ...
        <div id="running-text"
            ...
            <img src="{{ asset('favicon-32x32.png') }}" alt="divider"
                class="inline-block size-4 rounded-md bg-white mx-2">
            <span class="text-normal font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. </span>
            <img src="{{ asset('favicon-32x32.png') }}" alt="divider"
                class="inline-block size-4 rounded-md bg-white mx-2">
            <span class="text-normal font-medium">Itaque sint fugiat amet! Itaque sint fugiat amet!Itaque sint fugiat
                amet!Itaque sint fugiat amet!Itaque sint fugiat amet!</span>
            <img src="{{ asset('favicon-32x32.png') }}" alt="divider"
                class="inline-block size-4 rounded-md bg-white mx-2">
            <span class="text-normal font-medium">Perferendis alias temporibus quo nihil officiis hic distinctio enim
                veritatis dolorem tempore iusto, repudiandae voluptatem quos minima in. </span>
        </div>
    </div>
