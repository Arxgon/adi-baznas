                        ...
                        <div class="space-y-1">
                            <dl class="flex flex-col sm:flex-row gap-1">
                                <dt class="min-w-32 flex flex-row items-center">
                                    <span class="inline-flex justify-center items-center w-[40px] rounded-full text-green-800 dark:text-blue-500">
                            ...
                            <dl class="flex flex-col sm:flex-row gap-1">
                                <dt class="min-w-32 flex flex-row items-center">
                                    <span class="inline-flex justify-center items-center w-[40px] rounded-full text-green-800 dark:text-blue-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-printer-check">
